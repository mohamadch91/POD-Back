...
urlpatterns = [
    ...
    path('admin/actions/', ServiceActionsAdminView.as_view(), name='get all Service'),
    ...
    path('negotiate/chat/', NegotiateChatServiceView.as_view(), name='edit  Service'),
    path('admin/negotiate/chat/', NegotiateChatAdminServiceView.as_view(), name='edit  Service'),
    ...
    path('admin/question/confirm/', ServiceAdminQuestionConfirmView.as_view(), name='get all Service'),

    path('question/', ServiceQuestionView.as_view(), name='get all Service'),
    path('question/answer/', ServiceQuestionAnswerView.as_view(), name='get all Service'),
