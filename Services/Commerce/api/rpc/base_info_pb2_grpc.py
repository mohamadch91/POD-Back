...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in base_info_pb2_grpc.py depends on'
...
class BaseInfoControllerStub(object):
...
class BaseInfoControllerServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_BaseInfoControllerServicer_to_server(servicer, server):
    rpc_method_handlers = {
