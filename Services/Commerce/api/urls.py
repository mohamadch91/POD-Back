...
urlpatterns = [
    ...
    path('negotiate/chat/', NegotiateChatCommerceView.as_view(), name='edit  commerce'),
    path('admin/negotiate/chat/', NegotiateChatAdminCommerceView.as_view(), name='edit  commerce'),
    ...
    path('admin/question/confirm/', CommerceAdminQuestionConfirmView.as_view(), name='get all commerce'),
    path('question/', CommerceQuestionView.as_view(), name='get all commerce'),
    path('question/answer/', CommerceQuestionAnswerView.as_view(), name='get all commerce'),
